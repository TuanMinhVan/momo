...
class _ReactionsBoxState extends State<ReactionsBox>
  ...
  double? _getBoxHeight() {
    if (_boxSizeAnimation.value == null) return 54.0;
  ...
  void initState() {
    ...
    _boxSizeController = AnimationController(
      vsync: this,
          ...
          PositionedDirectional(
            ...
            child: Transform.scale(
              ...
              child: AnimatedBuilder(
                ...
                builder: (_, child) {
                  return SizedBox(
                    height: _boxSizeAnimation.value?.height ?? 72,
                    child: Stack(
                      ...
                      children: [
                        Material(
                          ...
                          child: SizedBox(
                            ...
                            width: min(
                              300,
                              _boxSizeAnimation.value?.width ?? 300.0,
                            ),
                          ),
                        ),
                        child!,
